...
```
### Packaging
You can build a full copy of Wrapper offline on all platforms. This command builds on your current environment:
```
npm run package
```
...
```
## WARNING: You can't build on Linux x86 due to sharp binaries being unavailable. And for macOS x86 also because Apple killed x86 support
